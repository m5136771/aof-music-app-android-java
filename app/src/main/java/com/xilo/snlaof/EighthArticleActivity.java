...
public class EighthArticleActivity extends AppCompatActivity implements Runnable {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eighth_article);

        //??
        handler = new Handler();

        //Display PDF
        pdfView = findViewById(R.id.article_8_display);
        pdfView.fromAsset("Article_8.pdf").load();

        //Constraint Sets
        constraintLayout = findViewById(R.id.cl8);
        constraintSet1.clone(constraintLayout);
        constraintSet2.clone(this, R.layout.activity_eighth_article_wp);

        //Floating Action Button
        FloatingActionButton fab8 = findViewById(R.id.fab8);
        fab8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create Media Player
                mp = new MediaPlayer().create(EighthArticleActivity.this, R.raw.article8);
        ...
        toggleSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (toggleSwitch.isChecked()) {
                    mp = MediaPlayer.create(EighthArticleActivity.this, R.raw.article8);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }else {
                    mp = MediaPlayer.create(EighthArticleActivity.this, R.raw.article8_inst);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }
