...
public class EleventhArticleActivity extends AppCompatActivity implements Runnable {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eleventh_article);

        //??
        handler = new Handler();

        //Display PDF
        pdfView = findViewById(R.id.article_11_display);
        pdfView.fromAsset("Article_11.pdf").load();

        //Constraint Sets
        constraintLayout = findViewById(R.id.cl11);
        constraintSet1.clone(constraintLayout);
        constraintSet2.clone(this, R.layout.activity_eleventh_article_wp);

        //Floating Action Button
        FloatingActionButton fab11 = findViewById(R.id.fab11);
        fab11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create Media Player
                mp = new MediaPlayer().create(EleventhArticleActivity.this, R.raw.article11);
        ...
        toggleSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (toggleSwitch.isChecked()) {
                    mp = MediaPlayer.create(EleventhArticleActivity.this, R.raw.article11);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }else {
                    mp = MediaPlayer.create(EleventhArticleActivity.this, R.raw.article11_inst);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }
