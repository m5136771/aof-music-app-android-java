...
public class FirstArticleActivity extends AppCompatActivity implements Runnable {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Display PDF
        pdfView = findViewById(R.id.article_1_display);
        pdfView.fromAsset("Article_1.pdf").load();

        //Constraint Sets
        constraintLayout = findViewById(R.id.cl1);
        constraintSet1.clone(constraintLayout);
        constraintSet2.clone(this, R.layout.activity_first_article_wp);
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create Media Player
                mp = new MediaPlayer().create(FirstArticleActivity.this, R.raw.article1);
        ...
        toggleSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (toggleSwitch.isChecked()) {
                    mp = MediaPlayer.create(FirstArticleActivity.this, R.raw.article1);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }else {
                    mp = MediaPlayer.create(FirstArticleActivity.this, R.raw.article1_inst);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }
