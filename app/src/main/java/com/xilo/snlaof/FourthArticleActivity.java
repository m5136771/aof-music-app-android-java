...
public class FourthArticleActivity extends AppCompatActivity implements Runnable {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Display PDF
        pdfView = findViewById(R.id.article_4_display);
        pdfView.fromAsset("Article_4.pdf").load();

        //Constraint Sets
        constraintLayout = findViewById(R.id.cl4);
        constraintSet1.clone(constraintLayout);
        constraintSet2.clone(this, R.layout.activity_fourth_article_wp);
        ...
        fab4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create Media Player
                mp = new MediaPlayer().create(FourthArticleActivity.this, R.raw.article4);
        ...
        toggleSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (toggleSwitch.isChecked()) {
                    mp = MediaPlayer.create(FourthArticleActivity.this, R.raw.article4);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }else {
                    mp = MediaPlayer.create(FourthArticleActivity.this, R.raw.article4_inst);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }
