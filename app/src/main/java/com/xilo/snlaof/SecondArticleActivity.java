...
public class SecondArticleActivity extends AppCompatActivity implements Runnable {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_article);

        //??
        handler = new Handler();

        //Display PDF
        pdfView = findViewById(R.id.article_2_display);
        pdfView.fromAsset("Article_2.pdf").load();

        //Constraint Sets
        constraintLayout = findViewById(R.id.cl2);
        constraintSet1.clone(constraintLayout);
        constraintSet2.clone(this, R.layout.activity_second_article_wp);
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create Media Player
                mp = new MediaPlayer().create(SecondArticleActivity.this, R.raw.article2);
        ...
        toggleSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (toggleSwitch.isChecked()) {
                    mp = MediaPlayer.create(SecondArticleActivity.this, R.raw.article2);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }else {
                    mp = MediaPlayer.create(SecondArticleActivity.this, R.raw.article2_inst);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }
