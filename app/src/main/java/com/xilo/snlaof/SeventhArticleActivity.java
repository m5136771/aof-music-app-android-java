...
public class SeventhArticleActivity extends AppCompatActivity implements Runnable {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seventh_article);

        //??
        handler = new Handler();

        //Display PDF
        pdfView = findViewById(R.id.article_7_display);
        pdfView.fromAsset("Article_7.pdf").load();

        //Constraint Sets
        constraintLayout = findViewById(R.id.cl7);
        constraintSet1.clone(constraintLayout);
        constraintSet2.clone(this, R.layout.activity_seventh_article_wp);

        //Floating Action Button
        FloatingActionButton fab7 = findViewById(R.id.fab7);
        fab7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create Media Player
                mp = new MediaPlayer().create(SeventhArticleActivity.this, R.raw.article7);
        ...
        toggleSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (toggleSwitch.isChecked()) {
                    mp = MediaPlayer.create(SeventhArticleActivity.this, R.raw.article7);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }else {
                    mp = MediaPlayer.create(SeventhArticleActivity.this, R.raw.article7_inst);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }
