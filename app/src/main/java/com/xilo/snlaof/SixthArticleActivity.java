...
public class SixthArticleActivity extends AppCompatActivity implements Runnable {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sixth_article);

        //??
        handler = new Handler();

        //Display PDF
        pdfView = findViewById(R.id.article_6_display);
        pdfView.fromAsset("Article_6.pdf").load();

        //Constraint Sets
        constraintLayout = findViewById(R.id.cl6);
        constraintSet1.clone(constraintLayout);
        constraintSet2.clone(this, R.layout.activity_sixth_article_wp);
        ...
        fab6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create Media Player
                mp = new MediaPlayer().create(SixthArticleActivity.this, R.raw.article6);
        ...
        toggleSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (toggleSwitch.isChecked()) {
                    mp = MediaPlayer.create(SixthArticleActivity.this, R.raw.article6);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }else {
                    mp = MediaPlayer.create(SixthArticleActivity.this, R.raw.article6_inst);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }
