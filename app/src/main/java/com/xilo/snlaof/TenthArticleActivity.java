...
public class TenthArticleActivity extends AppCompatActivity implements Runnable {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenth_article);

        //??
        handler = new Handler();

        //Display PDF
        pdfView = findViewById(R.id.article_10_display);
        pdfView.fromAsset("Article_10.pdf").load();

        //Constraint Sets
        constraintLayout = findViewById(R.id.cl10);
        constraintSet1.clone(constraintLayout);
        constraintSet2.clone(this, R.layout.activity_tenth_article_wp);
        ...
        fab10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create Media Player
                mp = new MediaPlayer().create(TenthArticleActivity.this, R.raw.article10);
        ...
        toggleSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (toggleSwitch.isChecked()) {
                    mp = MediaPlayer.create(TenthArticleActivity.this, R.raw.article10);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }else {
                    mp = MediaPlayer.create(TenthArticleActivity.this, R.raw.article10_inst);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }
