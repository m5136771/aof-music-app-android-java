...
public class ThirdArticleActivity extends AppCompatActivity implements Runnable {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Display PDF
        pdfView = findViewById(R.id.article_3_display);
        pdfView.fromAsset("Article_3.pdf").load();

        //Constraint Sets
        constraintLayout = findViewById(R.id.cl3);
        constraintSet1.clone(constraintLayout);
        constraintSet2.clone(this, R.layout.activity_third_article_wp);
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create Media Player
                mp = new MediaPlayer().create(ThirdArticleActivity.this, R.raw.article3);
        ...
        toggleSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (toggleSwitch.isChecked()) {
                    mp = MediaPlayer.create(ThirdArticleActivity.this, R.raw.article3);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }else {
                    mp = MediaPlayer.create(ThirdArticleActivity.this, R.raw.article3_inst);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }
