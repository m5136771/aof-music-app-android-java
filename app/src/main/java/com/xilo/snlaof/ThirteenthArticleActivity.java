...
public class ThirteenthArticleActivity extends AppCompatActivity implements Runnable {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thirteenth_article);

        //??
        handler = new Handler();

        //Display PDF
        pdfView = findViewById(R.id.article_13_display);
        pdfView.fromAsset("Article_13.pdf").load();

        //Constraint Sets
        constraintLayout = findViewById(R.id.cl13);
        constraintSet1.clone(constraintLayout);
        constraintSet2.clone(this, R.layout.activity_thirteenth_article_wp);

        //Floating Action Button
        FloatingActionButton fab13 = findViewById(R.id.fab13);
        fab13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create Media Player
                mp = new MediaPlayer().create(ThirteenthArticleActivity.this, R.raw.article13);
        ...
        toggleSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (toggleSwitch.isChecked()) {
                    mp = MediaPlayer.create(ThirteenthArticleActivity.this, R.raw.article13);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }else {
                    mp = MediaPlayer.create(ThirteenthArticleActivity.this, R.raw.article13_inst);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }
