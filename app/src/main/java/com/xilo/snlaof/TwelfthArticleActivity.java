...
public class TwelfthArticleActivity extends AppCompatActivity implements Runnable {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twelfth_article);

        //??
        handler = new Handler();

        //Display PDF
        pdfView = findViewById(R.id.article_12_display);
        pdfView.fromAsset("Article_12.pdf").load();

        //Constraint Sets
        constraintLayout = findViewById(R.id.cl12);
        constraintSet1.clone(constraintLayout);
        constraintSet2.clone(this, R.layout.activity_twelfth_article_wp);
        ...
        fab12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create Media Player
                mp = new MediaPlayer().create(TwelfthArticleActivity.this, R.raw.article12);
        ...
        toggleSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (toggleSwitch.isChecked()) {
                    mp = MediaPlayer.create(TwelfthArticleActivity.this, R.raw.article12);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }else {
                    mp = MediaPlayer.create(TwelfthArticleActivity.this, R.raw.article12_inst);
                    seekBar.setMax(mp.getDuration());
                    seekBar.setVisibility(ProgressBar.VISIBLE);
                    seekBar.setProgress(0);
                }
